...
import { ClipCreateType } from "./types";

export type SetupListenersProps = {
    abortControllerRef: MutableRefObject<AbortController | undefined>;
    addClip: (newEntry: ClipCreateType) => void;
    setIsRunning: Dispatch<SetStateAction<boolean>>;
};

export async function setupListeners({ abortControllerRef: abortRef, setIsRunning, addClip: addEntry }: SetupListenersProps) {
    try {
